...
class BookingPage extends StatefulWidget {
  ...
  const BookingPage({super.key, required this.clinic});
            ...
            GestureDetector(
              onTap:
                  () => _showBottomSheet(
                    context,
                    'Chọn phòng khám',
                    ['Phòng 101', 'Phòng 202', 'Phòng 303', 'Phòng VIP'],
                    (value) {
                      setState(() => selectedClinic = value);
                    },
                  ),
              child: _buildOptionField(
                selectedClinic ?? 'Chọn phòng khám',
                Icons.healing,
              ),
            ),
            SizedBox(height: 20),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              Icon(icon, color: Color.fromARGB(255, 65, 118, 209), size: 24),
              SizedBox(width: 10),
