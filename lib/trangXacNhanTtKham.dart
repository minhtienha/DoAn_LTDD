                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        // Chuyển hướng về trang chủ và xóa tất cả các trang trước đó
                        Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(
                            builder: (context) => TrangChu(),
                          ), // Đổi thành màn hình trang chủ của bạn
                          (Route<dynamic> route) =>
                              false, // Xóa toàn bộ stack, quay về màn hình chính
                        );
                      },
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Text(content, style: const TextStyle(fontSize: 17))),
        ],
      ),
    );
  }
